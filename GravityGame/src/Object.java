...
public class Object {
    ...
    public Object(int x, int y, double mass,double xvol,double yvol,boolean type,Color color,double density,double temperature) {
        this.x = x;
        this.y = y;
        this.mass = mass;
        this.xVelocity = xvol;
    ...
    public Color getColor() {
     ...
     public int vector(Object s1, Object s2){
    	//calculate x and y distance
         ...
         double radius =Math.max( Math.sqrt((xdistance*xdistance)+(ydistance*ydistance)),1); 
         //test for collision
...
//              if(0<red&&red<225&&0<green&&green<225&&0<blue&&blue<225){ 
//              s2.setColor(new Color((int)red,(int)green,(int)blue));
//              }
